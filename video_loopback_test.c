...
static void vpfe_init( Uint32 ntsc_pal_mode, Uint32 addr_buffer_in )
{
	Uint32 video_buffer = addr_buffer_in;
	Uint32 width;
	Uint32 height;
...
Uint32 output_mode, Uint32 addr_buffer_out )
{
	Uint32 video_buffer = addr_buffer_out;
	Uint32 basep_x;
	Uint32 basep_y;
	Uint32 width;
	Uint32 height;
...
Int16 video_loopback_test( Uint32 addr_buffer_in, Uint32 addr_buffer_out ){
	Int16 ntsc_pal_mode;
	Int16 output_mode;
...
printf("ntsc_pal_mode:%d\n", ntsc_pal_mode);
		...
		vpfe_init( ntsc_pal_mode, addr_buffer_in );

		/* Setup Back-End */
		vpbe_init( LOOPBACK, ntsc_pal_mode, output_mode, addr_buffer_out );/* Wait for the USER to press something useful */
